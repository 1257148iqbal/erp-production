  ...
  return (
    <div>
      <CustomModal
        ...
        handleMainModelSubmit={handleSubmit(onSubmit)}
              ...
              <Col xs="12" sm="12" md="12" lg="12" xl="12">
                <Row className="rounded rounded-3 mr-1">
                  ...
                  <FormGroup tag={Col} xs={12} sm={12} md={6} lg={6} xl={6}>
                    ...
                    />
                    {errors && errors.workingMinute && (
                      <FormFeedback>Working Minute is Required!</FormFeedback>
                    )}
                  </FormGroup>
                  <FormGroup tag={Col} xs={12} sm={12} md={6} lg={6} xl={6}>
                    ...
                    {errors && errors.efficiency && (
                      <FormFeedback>Efficiency is Required!</FormFeedback>
                    )}
                  </FormGroup>
                  <FormGroup tag={Col} xs={12} sm={12} md={6} lg={6} xl={6}>
